...
`src/components/chat/chat-screen.tsx:1144,2419` and drawn in the composer's
`+` menu at `src/components/chat/chat-composer.tsx:276-294`), and the picked image rides
